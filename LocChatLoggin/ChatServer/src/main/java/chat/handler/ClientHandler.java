...
//        new Timer().schedule();
        ...
        new Thread(() -> {
            ...
            try {
                ...
                if (!isAuthorized){
                    ...
                    myServer.getServerLogger().writeWarningLog("Соединение закрыто");
                }
    ...
    private void authentication() throws IOException {
        ...
        myServer.getServerLogger().writeInfoLog("Аутентификация");
        while (true) {
            ...
            if (command.getType() == CommandType.AUTH) {
                ...
                myServer.getServerLogger().writeWarningLog("Ошибка авторизации");
            }
        }
    ...
    private Command readCommand() throws IOException {
        try {
            ...
            myServer.getServerLogger().writeSevereLog(errorMessage);
            e.printStackTrace();
            return null;
        }
    }
