...
public class Main {
    ...
    public static void main(String[] args) {
        Integer[] mas = {1,2,3,4,5,1,6,7};
        Integer[] m = {1,2,3,5,6,7};
        Integer[] m1 = mas;
        Integer[] m2 = m;
        MassiveProcess.printMassive(MassiveProcess.takeAfterFour(mas));
        MassiveProcess.printMassive(MassiveProcess.takeAfterFour(m));
    }
}
